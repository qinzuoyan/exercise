...
public:
    BalancedBST(bool allow_duplicate = false) :
        _t(NULL), _d(allow_duplicate)
    {
    }
    ...
    int lessThan(int n) const
    {
        return lessThan(n, _t);
    }
